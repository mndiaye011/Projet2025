public abstract class OeuvreDart
{
    ...
    public OeuvreDart(string titre, double largeur, double hauteur, bool estLumineuse, bool couleursChaudes)
    {
        this.titre = titre;
